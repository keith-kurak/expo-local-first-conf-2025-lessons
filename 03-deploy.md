...
Let's learn how to deploy mobile apps with Expo
...
- How to build and deploy the server solution with Cloudflare Durable Objects and the frontends with EAS

### Tasks

- Learn about development builds, especially how and when to transition from Expo Go to using a development build
- Learn how to setup app variants with EAS environment variables and a dynamic app config.
- Learn how to deploy for mobile and web with EAS Build and EAS Hosting.
